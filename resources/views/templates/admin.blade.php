        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href=" {{ route('admin.index') }} " class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Beranda</a>
                    <a href=" {{ url('admin/produk') }} " class="nav-item nav-link"><i class="fa fa-box me-2"></i>Produk</a>

                    <a href=" {{ url('admin/transaksi') }} " class="nav-item nav-link"><i class="fa fa-handshake me-2"></i>Transaksi</a>
